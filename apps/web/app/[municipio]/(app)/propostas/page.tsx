                ...
                <tr key={item.id} className="border-t border-neutral-200 dark:border-neutral-800">
                  ...
                  <td className="px-4 py-2">
                    ...
                    {item.convenioGeradoId && (
                      <Link href={rota(`/convenios/${item.convenioGeradoId}`)} className="ml-2 text-blue-600 hover:underline">
                        (ver convênio)
                      </Link>
                    )}
                  </td>
                  <td className="px-4 py-2 text-right">
                    <Link href={rota(`/propostas/${item.id}`)} className="mr-3 text-blue-600 hover:underline">
